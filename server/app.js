...
//執行手機註冊
app.post('/MblieRegister', routes.MblieRegister);
//執行手機登入
app.post('/MblieLogin', routes.MblieLogin);
//執行手機登出
app.post('/MblieLogout', routes.MblieLogout);


//執行手機新增員工資料
app.post('/MblieAddMember', routes.MblieAddMember);
//執行手機刪除員工資料
app.post('/MblieDelMember', routes.MblieDelMember);
//執行手機更新員工資料
app.post('/MblieUpdateMember', routes.MblieUpdateMember);
//執行手機取得員工資料
app.post('/MblieGetMember', routes.MblieGetMember);
 
 
 //執行手機 開始Spin
app.post('/MblieStartSpin', routes.MblieStartSpin);
 
//執行手機新增顧客資料
app.post('/MblieAddCustomer', routes.MblieAddCustomer);
/*
//執行手機刪除顧客資料
app.post('/MblieDelCustomer', routes.MblieDelCustomer);

//執行手機更新顧客資料
app.post('/MblieUpdateCustomer', routes.MblieUpdateCustomer);

//執行手機取得顧客資料
app.post('/MblieGetCustomer', routes.MblieGetCustomer);
*/
process.on('uncaughtException', function (err) {
  logger.error('發生例外 err=' + err);
});
